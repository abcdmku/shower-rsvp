    ...
    <Form className="dusty-rose-light p-3 rounded-2" onSubmit={handleSubmit(onSubmit)}>
      ...
      <Stack gap={4}>
        ...
        <div style={{maxHeight: attending ? '100px': '0px', transition: 'all 500ms', overflowY: 'hidden'}}>
          <Form.Group controlId="people" className='mx-1'>
            <Form.Label className="mb-1">How many others will be attending with you?</Form.Label>
            <Form.Control type="number" defaultValue={0} {...register("people")}/>
          </Form.Group>
        </div>
